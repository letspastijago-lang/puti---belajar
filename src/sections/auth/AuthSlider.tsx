...
// ASSETS
const Avatar1 = withBasePath('/assets/images/users/avatar-1.png');
const Avatar2 = withBasePath('/assets/images/users/avatar-2.png');
const Avatar3 = withBasePath('/assets/images/users/avatar-3.png');
const Avatar4 = withBasePath('/assets/images/users/avatar-4.png');
