...
// ASSETS
const defaultLayout = withBasePath('/assets/images/customization/ltr.svg');
const rtlLayout = withBasePath('/assets/images/customization/rtl.svg');
const miniMenu = withBasePath('/assets/images/customization/mini-menu.svg');
