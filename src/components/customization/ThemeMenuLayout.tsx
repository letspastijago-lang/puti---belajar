...
// ASSETS
const defaultLayout = withBasePath('/assets/images/customization/vertical.svg');
const horizontalLayout = withBasePath('/assets/images/customization/horizontal.svg');
